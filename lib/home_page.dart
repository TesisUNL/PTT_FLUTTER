...
import 'core/constants/components.dart';
          ...
          child: Stack(
            children: <Widget>[
              ...
              offsetSearch != 0
                ...
                width: realW(320),
                height: realH(135 * (currentSearchPercent as double)),
                child: Opacity(
              ...
              MapButton(
                ...
                height: 71,
                isRight: false,
                icon: Icons.layers, gradient: LinearGradient(
                  colors: [Color(0x0000ffff)]
              ), iconColor: Color(0x0000ffff),
              ),
              //directions button
              MapButton(
                currentSearchPercent: currentSearchPercent,
              ...
              MapButton(
                ...
                iconColor: Colors.blue, gradient: LinearGradient(
                colors: [Color(0x0000ffff)]
              ),
              ),
              //menu button
              Positioned(
                bottom: realH(53),
                left: realW(-71 * (double.parse(currentExplorePercent) + currentSearchPercent)),
                child: GestureDetector(
                  onTap: () {
                    animateMenu(true);
                  },
                  child: Opacity(
                    opacity: 1 - (double.parse(currentSearchPercent) + currentExplorePercent),
                    child: Container(
                      width: realW(71),
                      height: realH(71),
